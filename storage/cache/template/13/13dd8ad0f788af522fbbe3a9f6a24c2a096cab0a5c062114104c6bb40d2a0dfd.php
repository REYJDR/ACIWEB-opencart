...
class __TwigTemplate_8c92c492edba3c8904be344415f606295b0f35d160b2bf2233529e831010812a extends Twig_Template
{
    private $source;
...
<div id=\"content\">
  <div class=\"page-header\">
    <div class=\"container-fluid\">
      <div class=\"float-right\"><a href=\"";
        ...
        echo "') ? \$('#form-zone').submit() : false;\"><i class=\"fas fa-trash-alt\"></i></button>
      </div>
      <h1>";
        // line 8
  ...
  <div class=\"container-fluid\">";
      ...
      <div class=\"card-body\">
        ...
        if (($context["zones"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["zone"]) {
                ...
                // line 58
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["zone"], "zone_id", []), ($context["selected"] ?? null))) {
                    // line 59
                    echo "                          <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["zone"], "zone_id", []);
                ...
                echo "</td>
                      <td class=\"text-left\">";
                // line 63
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "country", []);
                echo "</td>
                      <td class=\"text-left\">";
                // line 64
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "name", []);
                echo "</td>
                      <td class=\"text-left\">";
                // line 65
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "code", []);
                echo "</td>
                      <td class=\"text-right\"><a href=\"";
                // line 66
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "edit", []);
                echo "\" data-toggle=\"tooltip\" title=\"";
    ...
    {
        return new Twig_Source("", "localisation/zone_list.twig", "");
    }
}
