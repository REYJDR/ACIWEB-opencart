    ...
    public function getOrders($data) {
        ...
        $this->setUserErrorAdvice();
          ...
          try{
                ...
                if ($data['filter_store_id'])   $where == '' ? $where = " where o.store_id = {$data['filter_store_id']}" :  $where .= " AND o.store_id = {$data['filter_store_id']}";
                ...
                if ($order_query->num_rows) {
                        ...
                        foreach ($order_query->rows as $key => $row) {
                            ...
                            $order[$key]['header'] = array(
                                ...
                                // 'comment'                 => $row['comment'],
                                'total'                   => $total_query->row['value'],
                                'subtotal'                => $subtotal_query->row['value'],
