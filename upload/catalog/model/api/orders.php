...
foreach ($order_query->row as $key => $row) {
    ...
    if ($order_query->num_rows) {
        ...
        if ($language_info) {
            ...
            $language_code = $this->config->get('config_language');
                    ...
                    $product_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order_product` WHERE order_id = '" . (int)$order_query->row['order_id'] . "'");
                        



                    $res[$key]['header'] = array('order_id'                => $order_query->row['order_id'],
                                ...
                                $res[$key]['detail'] = $product_query->row;         
                  }
